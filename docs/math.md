...
- 🏚️ [ChunkedArrays.jl](https://github.com/ChrisRackauckas/ChunkedArrays.jl) : A package for increasing the performance of arrays generated iteratively. (No `Project.toml`)
- 🏚️ [Expokit.jl](https://github.com/acroy/Expokit.jl) : [EXPOKIT](https://www.maths.uq.edu.au/expokit) efficiently calculates the action of matrix exponentials on vectors for large sparse matrices.. (No `Project.toml`)
...
- 🏚️ [Tetris.jl](https://github.com/djsegal/Tetris.jl) : GUI Tetris. (No `Project.toml`)
